...
exports.initializeUploadRoutes = void 0;
...
const initializeUploadRoutes = (controller) => {
    uploadController = controller;
    return router;
};
exports.initializeUploadRoutes = initializeUploadRoutes;
...
const imageUploadConfig = (0, multer_1.default)({
    storage,
    limits: {
...
const avatarUploadConfig = (0, multer_1.default)({
    storage,
    limits: {
 ...
 * }
 */
router.post("/single", authenticate_1.authenticate, uploadRateLimit, uploadConfig.single("file"), async (req, res, next) => {
    try {
 ...
 * }
 */
router.post("/multiple", authenticate_1.authenticate, uploadRateLimit, uploadConfig.array("files", 10), async (req, res, next) => {
    try {
 ...
 * }
 */
router.post("/avatar", authenticate_1.authenticate, avatarUploadLimit, avatarUploadConfig.single("file"), async (req, res, next) => {
    try {
 ...
 * }
 */
router.get("/user-files", authenticate_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @param   fileId - File ID
 */
router.delete("/file/:fileId", authenticate_1.authenticate, async (req, res, next) => {
    try {
 ...
 * @body    { fileIds: string[] }
 */
router.delete("/bulk-delete", authenticate_1.authenticate, async (req, res, next) => {
    try {
        res.status(501).json({
            success: false,
 ...
 * }
 */
router.post("/transform/:fileId", authenticate_1.authenticate, uploadRateLimit, async (req, res, next) => {
    try {
        res.status(501).json({
            success: false,
 ...
 * }
 */
router.post("/optimize/:fileId", authenticate_1.authenticate, uploadRateLimit, async (req, res, next) => {
    try {
        res.status(501).json({
            success: false,
