 ...
 * }
 */
router.post("/save-for-later/:productId", authenticate_1.authenticate, cartController.saveForLater);
/**
 ...
 * }
 */
router.post("/move-to-cart/:productId", authenticate_1.authenticate, cartController.moveToCart);
