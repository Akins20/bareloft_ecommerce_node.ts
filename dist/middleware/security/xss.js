...
exports.sanitizeRichContent = exports.xssProtection = void 0;
...
const sanitizeString = (str) => {
    ...
    let sanitized = isomorphic_dompurify_1.default.sanitize(str, {
...
const xssProtection = (req, res, next) => {
    try {
        ...
        if (sanitizationOccurred) {
            winston_1.logger.warn("XSS attempt detected and sanitized", {
                ip: req.ip,
        ...
        winston_1.logger.error("XSS protection middleware error", {
 ...
 */
const sanitizeRichContent = (content) => {
    return isomorphic_dompurify_1.default.sanitize(content, {
        ALLOWED_TAGS: [
            "p",
            "br",
            "strong",
