...
class OrderController extends BaseController_1.BaseController {
    ...
    cancelOrder = async (req, res) => {
        try {
            ...
            const result = await this.orderService.cancelOrder(orderId, reason.trim(), userId);
            res.json(result);
        }
        catch (error) {
            this.handleError(error, req, res);
    ...
    updateOrderStatus = async (req, res) => {
        try {
            ...
            const result = await this.orderService.updateOrderStatus(orderId, status, adminNotes, updatedBy);
            res.json(result);
        }
        catch (error) {
            this.handleError(error, req, res);
    ...
    calculateEstimatedDelivery(orderDate, status) {
