...
class ReportFormatters {
     ...
     */
    static async generatePDFReport(data, title) {
...
Report generated by Bareloft E-commerce Admin System
     ...
     */
    static generateExcelCSV(data, sheetName = 'Report') {
        if (!data || data.length === 0) {
            return '';
        }
     ...
     */
    static formatForNigerianExport(data) {
        return data.map(row => {
            const formattedRow = {};
...
exports.ReportFormatters = ReportFormatters;
/**
