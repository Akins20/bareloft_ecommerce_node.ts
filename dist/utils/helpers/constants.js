...
exports.getEnvironmentConfig = exports.isFeatureEnabled = exports.getConstant = exports.CONSTANTS = exports.ENVIRONMENT_CONSTANTS = exports.FEATURE_FLAGS = exports.MONITORING_CONSTANTS = exports.SECURITY_CONSTANTS = exports.ANALYTICS_CONSTANTS = exports.NOTIFICATION_CONSTANTS = exports.API_CONSTANTS = exports.UPLOAD_CONSTANTS = exports.PAYMENT_CONSTANTS = exports.BUSINESS_CONSTANTS = exports.AUTH_CONSTANTS = exports.NIGERIAN_CONSTANTS = void 0;
// Nigerian Market Constants
exports.NIGERIAN_CONSTANTS = {
    COUNTRY_CODE: "NG",
    CURRENCY: "NGN",
    CURRENCY_SYMBOL: "₦",
...
exports.NOTIFICATION_CONSTANTS = {
    ...
    SMS_TEMPLATES: {
        ...
        PAYMENT_RECEIVED: "Payment of {{amount}} received for order {{orderNumber}}.",
    },
};
// Analytics Constants
...
exports.CONSTANTS = {
    NIGERIAN: exports.NIGERIAN_CONSTANTS,
    AUTH: exports.AUTH_CONSTANTS,
    BUSINESS: exports.BUSINESS_CONSTANTS,
    PAYMENT: exports.PAYMENT_CONSTANTS,
    UPLOAD: exports.UPLOAD_CONSTANTS,
    API: exports.API_CONSTANTS,
    NOTIFICATION: exports.NOTIFICATION_CONSTANTS,
    ANALYTICS: exports.ANALYTICS_CONSTANTS,
    SECURITY: exports.SECURITY_CONSTANTS,
    MONITORING: exports.MONITORING_CONSTANTS,
    FEATURES: exports.FEATURE_FLAGS,
    ENVIRONMENT: exports.ENVIRONMENT_CONSTANTS,
};
// Utility functions for constants
const getConstant = (category, key) => {
    return exports.CONSTANTS[category][key];
};
...
const getEnvironmentConfig = (env) => {
    return exports.ENVIRONMENT_CONSTANTS[env];
};
