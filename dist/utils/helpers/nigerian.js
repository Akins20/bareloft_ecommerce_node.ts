...
exports.NigerianUtils = exports.NigerianMarketplaceUtils = exports.NigerianEcommerceUtils = exports.NigerianValidationUtils = exports.NigerianBusinessUtils = exports.NigerianLocationUtils = exports.NairaCurrencyUtils = exports.NigerianPhoneUtils = void 0;
const types_1 = require("../../types");
/**
 * Nigerian phone number utilities
 */
class NigerianPhoneUtils {
    static COUNTRY_CODE = "+234";
    static PHONE_REGEX = /^(\+234|234|0)[789][01][0-9]{8}$/;
    // Network prefixes for major Nigerian carriers
    static NETWORK_PREFIXES = {
        MTN: [
            "0803",
            "0806",
            "0703",
     ...
     */
    static toOTPFormat(phone) {
        return this.format(phone).replace(/\D/g, "");
    }
}
exports.NigerianPhoneUtils = NigerianPhoneUtils;
/**
 * Nigerian currency (Naira) utilities
 */
class NairaCurrencyUtils {
    static CURRENCY_CODE = "NGN";
    static CURRENCY_SYMBOL = "₦";
    /**
     * Format amount as Nigerian Naira
     */
    static format(amount, options) {
        const { showSymbol = true, decimalPlaces = 2, useGrouping = true, } = options || {};
...
exports.NairaCurrencyUtils = NairaCurrencyUtils;
/**
 * Nigerian states and location utilities
 */
class NigerianLocationUtils {
    /**
     * Validate Nigerian state
     */
    static validateState(state) {
        return types_1.NIGERIAN_STATES.includes(state);
    }
    /**
     * Get all Nigerian states
     */
    static getAllStates() {
        return types_1.NIGERIAN_STATES;
    }
    /**
     * Get states by geopolitical zone
     */
    static getStatesByZone(zone) {
        const zones = {
            "north-central": [
                "Benue",
                "FCT",
    ...
    static getShippingZone(state) {
        ...
        if (northernZones.includes(state))
            return "north";
        return "south";
    }
    /**
     ...
     */
    static getDeliveryEstimate(state) {
     ...
     */
    static calculateShippingCost(state, weight, // in kg
    orderAmount) {
        const zone = this.getShippingZone(state);
...
exports.NigerianLocationUtils = NigerianLocationUtils;
/**
 * Nigerian business utilities
 */
class NigerianBusinessUtils {
    /**
     ...
     */
    static getCurrentNigerianTime() {
        return new Date(new Date().toLocaleString("en-US", { timeZone: "Africa/Lagos" }));
    }
    /**
     * Format Nigerian date
     */
    static formatNigerianDate(date, format = "short") {
     ...
     */
    static isNigerianPublicHoliday(date) {
...
exports.NigerianBusinessUtils = NigerianBusinessUtils;
/**
 * Nigerian business validation utilities
 */
class NigerianValidationUtils {
    /**
     * Validate Nigerian Business Registration Number (RC Number)
     */
    static validateBusinessRegistrationNumber(rcNumber) {
     ...
     */
    static validateNigerianName(name) {
...
exports.NigerianValidationUtils = NigerianValidationUtils;
/**
 * Nigerian e-commerce specific utilities
 */
class NigerianEcommerceUtils {
    /**
     * Generate Nigerian-friendly product SKU
     */
    static generateSKU(category, productName, variant) {
     ...
     */
    static calculateImportDuty(productCategory, costPrice) {
     ...
     */
    static getRecommendedPaymentMethods(orderAmount) {
        return [
            {
                method: "card",
                priority: 1,
     ...
     */
    static formatTrackingMessage(orderNumber, status, location) {
     ...
     */
    static calculateDeliveryDate(state, shippedDate = new Date()) {
     ...
     */
    static generateTrackingUrl(orderNumber) {
        return `https://bareloft.com/track/${orderNumber}`;
    }
    /**
     * Format Nigerian customer service message
     */
    static formatCustomerServiceMessage(customerName, issue, ticketNumber) {
     ...
     */
    static requiresSpecialHandling(productCategory, productName) {
...
ITEMS:
${orderData.items
            .map((item) => `${item.name} x${item.quantity} @ ${NairaCurrencyUtils.format(item.unitPrice)} = ${NairaCurrencyUtils.format(item.total)}`)
            .join("\n")}
...
exports.NigerianEcommerceUtils = NigerianEcommerceUtils;
/**
 * Nigerian marketplace utilities
 */
class NigerianMarketplaceUtils {
    /**
     ...
     */
    static getSeasonalTrends(month) {
        const trends = {
            1: {
                // January
                trending: [
     ...
     */
    static generateCulturalProductTags(category) {
        const culturalTags = {
            fashion: [
                "African print",
                "Ankara style",
        ...
        return (culturalTags[category.toLowerCase()] || [
            "Quality assured",
            "Customer tested",
            "Nigerian approved",
        ]);
...
exports.NigerianMarketplaceUtils = NigerianMarketplaceUtils;
/**
 * Export all Nigerian utilities as a single object for easy import
 */
exports.NigerianUtils = {
...
exports.default = exports.NigerianUtils;
//# sourceMappingURL=nigerian.js.map