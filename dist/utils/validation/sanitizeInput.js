...
class InputSanitizer {
    ...
    static sanitizeHTML(input) {
        ...
        const cleanHTML = isomorphic_dompurify_1.default.sanitize(input, {
            ALLOWED_TAGS: [
                "b",
                "i",
                "em",
    ...
    static sanitizeEmail(email) {
        ...
        return validator_1.default.normalizeEmail(email.trim().toLowerCase()) || "";
    }
    /**
    ...
    static sanitizeComment(comment) {
        ...
        let sanitized = validator_1.default.escape(comment);
        // Trim and normalize spaces
        sanitized = sanitized.trim().replace(/\s+/g, " ");
    ...
    static middleware(options = {}) {
        const { sanitizeBody = true, sanitizeQuery = true, sanitizeParams = true, customSanitizers = {}, } = options;
        return (req, res, next) => {
            try {
     ...
     */
    static sanitizeObject(obj, customSanitizers) {
     ...
     */
    static sanitizeStringByContext(key, value) {
