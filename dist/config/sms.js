...
exports.smsConfig = {
    ...
    templates: {
        otp: {
            login: "Your Bareloft login code is: {code}. Valid for {minutes} minutes.",
            signup: "Welcome to Bareloft! Your verification code is: {code}. Valid for {minutes} minutes.",
            passwordReset: "Your Bareloft password reset code is: {code}. Valid for {minutes} minutes.",
            phoneVerification: "Verify your phone with code: {code}. Valid for {minutes} minutes.",
        },
        notifications: {
            orderConfirmed: "Order #{orderNumber} confirmed! Total: ₦{amount}. Track: {trackingUrl}",
            orderShipped: "Order #{orderNumber} shipped via {carrier}. Track: {trackingNumber}",
            orderDelivered: "Order #{orderNumber} delivered! Rate your experience: {ratingUrl}",
